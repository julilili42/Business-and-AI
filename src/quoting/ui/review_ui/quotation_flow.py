...
def hydrate_existing_review_state(content_hash: str, matches) -> None:
    ...
    if quotation:
        ...
        st.session_state["pdf_file_name"] = f"Angebot_Draft_{review_id or content_hash}.pdf"
...
def render_generate_button(
    ...
    with st.spinner("PDF wird aktualisiert..." if is_review_mode else "Erstelle PDF..."):
        try:
            agent_lang = st.session_state.get("agent_lang", "de")
